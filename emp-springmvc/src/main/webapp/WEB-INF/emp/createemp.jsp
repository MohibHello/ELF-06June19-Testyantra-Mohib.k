							...
							<div class="container-fluid">
								...
								<div class="row">
									<div class="col-sm-4">
										...
										<div>
											<input type="text" class="form-control" id="id" name="empOtherinfo.id"
									...
									<div class="col-sm-4">
										...
										<div>
											<input type="text" class="form-control" id="mothername"
												name="empOtherinfo.motherName" placeholder="Enter Mother Name">
										</div>
									</div>
								</div>
								<br>
								<div class="row">
									<div class="col-sm-4">
										...
										<div>
											<input type="text" class="form-control" id="pan" name="empOtherinfo.pan"
								...
								<div class="row">
									<div class="col-sm-4">
										<div>
											<label for="physicallychallenged">Phyically
												challenged</label>
										</div>
										<div>
